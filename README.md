...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cmlib-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12706&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cmlib-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cmlib` can be installed with:

```
conda install cmlib
```

It is possible to list all of the versions of `cmlib` available on your platform with:
